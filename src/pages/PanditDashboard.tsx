...
import { Calendar, MapPin, Clock, User, ArrowRight, CheckCircle, XCircle, MoreVertical, Phone, TrendingUp, Users, Star } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

const MOCK_BOOKINGS = [
  { id: '1', puja: 'Griha Pravesh', user: 'Rahul M.', area: 'Kothrud', date: '2026-04-10', time: '09:00 AM', status: 'Confirmed', price: 5100 },
  { id: '2', puja: 'Satyanarayan Puja', user: 'Sneha K.', area: 'Baner', date: '2026-03-15', time: '11:00 AM', status: 'Completed', price: 3100 },
  { id: '3', puja: 'Ganesh Puja', user: 'Amit P.', area: 'Wakad', date: '2026-04-20', time: '08:30 AM', status: 'Pending', price: 2100 },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div>
            ...
            <p className="text-slate-500">Manage your sacred services and spiritual journey.</p>
          </div>
                ...
                >
                  <div className="flex gap-6 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 font-medium mb-2">{booking.user}</p>
